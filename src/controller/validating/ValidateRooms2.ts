...
// }
//
// function checkContentInRooms(content: string): Promise<string[]> {
...
// 			}
// 			for (let el in buildingArr) {
// 				tbody2 = [];
// 				trArr2 = [];
// 				roomList = [];
// 				roomExistsArr = [];
// 				let childNodes1: any = buildingArr[el].childNodes;
...
// 				console.log(link);
// 				// handGeo("http://cs310.students.cs.ubc.ca:11316/api/v1/project_team593/6398%20University%20Boulevard").then((result: any)=>{
// 				// 	console.log("inside.then");
// 				// 	console.log(result);
// 				// });
// 				console.log("outside HandGeo");
// 				// Promise.all(promiseURLS).then((urlResult: any)=>{
...
// 			return handGeo("http://cs310.students.cs.ubc.ca:11316/api/v1/project_team593/6398%20University%20Boulevard");
// 		}).then((result) => {
...
// 		// let buildingInfo = el.childNodes;
// 		// for (let index in el) {
// 		// 	console.log("HEEE");
...
// 	let nodeStr1 = roomContent.childNodes[3].childNodes[0].value.toString().trim();
...
// 	// let strReplace = nodeStr3.replace(/\n/g,"");
...
// }
//
// function clearSpaces(strArr: string[]): any {
// 	// https://www.techiedelight.com/remove-whitespaces-string-javascript/#:~:text=Using%20Split()%20with%20Join()%20method&text=Download%20Run%20Code-,To%20remove%20all%20whitespace%20characters,string%2C%20use%20%5Cs%20instead.&text=That's%20all%20about%20removing%20all%20whitespace%20from%20a%20string%20in%20JavaScript.
...
// }
//
// // credit - tree traversal strategy gotten from:
// // https://stackoverflow.com/questions/38967039/finding-a-specific-element-in-an-arbitrary-tree
...
// }
// export {
// 	checkContentInIndex, checkContentInRooms, mapOfBuildingsRooms, handGeo
// };
